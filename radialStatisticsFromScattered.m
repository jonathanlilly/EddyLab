function[mz,rmid,numz,stdz1,stdz2] = radialStatisticsFromScattered(x,y,t,z,rbin,tbin,options)
%radialStatisticsFromScattered  Radial statistics from scattered data.
%
%   [MZ,RMID,NUMZ,STDZ1,STDZ2] = ...
%        radialStatisticsFromScattered(X,Y,T,Z,RBIN,TBIN) computes radial 
...
%   whether the function is called with the firstAverage = "azimuthal"
%   or firstAverage = "temporal" option.  See the documentation at 
%   radialStatisticsFromGridded for further details. 
%
%   The functionality of radialStatisticsFromScattered is the same as that
%   of radialStatisticsFromGridded, but the former is intended to be used
%   with irregularly sampled data, such as alongtrack altimeter data, and
%   the latter with gridded model or observational data.
%
%   See also radialStatisticsFromGridded.
%
%   Usage:  [mz,rmid,numz,stdz1,stdz2] = ...
%                 radialStatisticsFromScattered(x,y,t,z,rbin,tbin)
