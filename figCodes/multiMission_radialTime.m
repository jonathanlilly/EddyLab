...
%%
%Full
[mz_rt, rmid_rt, tmid_rt, numz_rt, stdz_rt] = radialProfileTime(currentMission,eddyPath_fun_t,"tbin_size",10,showplot=0);
data{1} = {mz_rt, rmid_rt, tmid_rt, numz_rt, stdz_rt};

%OSSE
[mz_rt, rmid_rt, tmid_rt, numz_rt, stdz_rt] = radialProfileTime(currentMission,eddyPath_fun_t,showplot=0);
data{2} = {mz_rt, rmid_rt, tmid_rt, numz_rt, stdz_rt};
% 
row=1;
%%
figname='multiMission_radtime';
plot_data = data;
%% subplots
