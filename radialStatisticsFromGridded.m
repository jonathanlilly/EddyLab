function[mz,rmid,numz,stdz1,stdz2] = radialStatisticsFromGridded(x,y,z,options)
%radialStatisticsFromGridded  Radial statistics from gridded data.
%
%   [MZ,RMID,TMID,NUMZ,STDZ1,STDZ2] = radialStatisticsFromGridded(X,Y,Z)
...
%
%   [...] = radialStatisticsFromGridded(...,firstAverage = "azimuthal") 
...
%
%   [...] = radialStatisticsFromGridded(...,firstAverage = "temporal") 
...
%
%   See also radialStatisticsFromScattered.
%
%   Usage:  [mz,rmid,numz,stdz1,stdz2] = radialStatisticsFromGridded(x,y,z)
