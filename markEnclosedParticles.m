function[isEnclosed]=markEnclosedParticles(x,y,xc,yc)
%markEnclosedParticles  True for particles enclosed within a given contour.
%
%   ISENCLOSED = markEnclosedParticles(XA,YA,XC,YC), where XA and YA give
...
%   and YC=CELLADD(YPC,YO) where XO and YO are the EDDYCENTER locations. 
%
%   Usage: isEnclosed=markEnclosedParticles(xa,ya,xc,yc)
